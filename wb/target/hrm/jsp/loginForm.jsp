			...
			<div class="page-lock-info">
				...
				<c:choose>
					<c:when test="${login_error==null}">
						<span style="padding-top: 5px"><font color="black">请登录</font></span>
					</c:when>
					<c:otherwise>
						<span style="padding-top: 5px"><font color="red">${login_error}</font></span>
					</c:otherwise>
				</c:choose>
					...
					<div class="controls">
						<div class="input-icon left">
							<i class="icon-lock"></i> <input
								taglibs-standard-impl								class="m-wrap placeholder-no-fix" type="password"
